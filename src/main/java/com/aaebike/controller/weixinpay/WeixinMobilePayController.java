package com.aaebike.controller.weixinpay;
...
import com.aaebike.common.utils.DateUtils;
    ...
    public String dopay(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if ("SUCCESS".equals(returnCode)) {
            ...
            if ("SUCCESS".equals(resultCode)) {
                ...
                // 该订单已支付
                url.append("redirect:/weixinMobile/error?code=0&orderNo=" + orderNo);
            }
        } else {
            logger.info("订单号:{}错误信息:{}", orderNo, returnMsg);
            // 系统错误
            url.append("redirect:/weixinMobile/error?code=1&orderNo=" + orderNo);
        }
        return url.toString();
    }
